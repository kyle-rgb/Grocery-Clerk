...
async function insertRun({functionName, collection, executor, args=undefined, push=false, run_id=undefined , description=null}){
    /**
...
program
    ...
    .option("-i, --run_id <ObjectId>", "mongoDB created ObjectId generated by an initial call to insert")
