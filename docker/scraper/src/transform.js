...
const tryZip = () => {
    ...
    var cmd = spawn("tar", ["--remove-files", "-cvzf", "-", "../../../data/collections", "|", "gpg", "--output", `${ds}.tar.gz.gpg`, "--trust-model", "always", '--encrypt', '--recipient', process.env.EMAIL])
...
function summarizeNewCoupons(target, parser, uuid){
    ...
    */ 
    ...
    //console.log(allCoupons.slice(0, 5))
