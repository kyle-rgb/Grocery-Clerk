...
with DAG(
    ...
    start_container() >> [insertRun("getDollarGeneralPromotions", "get dollar general promotions data"), scrape_dataset("dollar-general", "promotions")] >> updateRun(push=False) >> stop() >> send_email