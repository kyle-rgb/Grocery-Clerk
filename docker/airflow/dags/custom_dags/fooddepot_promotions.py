...
with DAG(
    ...
    start_container() >> [insertRun("getFoodDepotPromotions", "get food depot's internal promotions hosted by appcard"), scrape_dataset("food-depot", "promotions")] >> updateRun(push=False) >> stop() >> send_email