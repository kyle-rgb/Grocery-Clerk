...
with DAG(
    ...
    start_container() >> [insertRun("getFamilyDollarInstacartItems", "get family dollar delivery price, inventory and promotional data"), scrape_dataset("family-dollar", "instacartItems")] >> updateRun(push=False) >> stop() >> send_email