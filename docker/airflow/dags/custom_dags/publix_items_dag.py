...
with DAG(
    ...
    start_container() >> [insertRun("getPublixItems", "get publix's item, pricing and inventory data"), scrape_dataset("publix", "items")] >> updateRun(push=False) >> stop() >> send_email